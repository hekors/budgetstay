...
const HeroSection = () => {
    return (
        <Box className="hero-section-bg" bgColor={"black"} py={"20"}>
            ...
            <Box width={"fit-content"} display={"flex"} flexDirection={"row"} gap={"6"} mt={"12"} marginLeft={"auto"} marginRight={"auto"}
                position={"relative"}
            >
                <Img src={"/assets/free-tag.svg"} position={"absolute"} bottom={"-10"} left={"-32"} />
            ...
            <Img src={"/assets/buildings.svg"} display={"block"} marginRight={"auto"} marginLeft={"auto"}
                mt={"10"}
            />
        </Box>
    )
